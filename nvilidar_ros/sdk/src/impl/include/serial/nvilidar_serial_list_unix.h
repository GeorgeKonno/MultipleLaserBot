...
#ifndef _NVILIDAR_SERIAL_LIST_UNIX
#define _NVILIDAR_SERIAL_LIST_UNIX
...
inline vector<NvilidarPortInfo> nvilidar_list_ports()
{
    vector<NvilidarPortInfo> results;
